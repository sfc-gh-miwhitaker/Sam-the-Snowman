...
GRANT REFERENCES, SELECT ON ALL SEMANTIC VIEWS IN SCHEMA SNOWFLAKE_EXAMPLE.SEMANTIC_MODELS TO ROLE ANALYTICS_TEAM;
GRANT REFERENCES, SELECT ON FUTURE SEMANTIC VIEWS IN SCHEMA SNOWFLAKE_EXAMPLE.SEMANTIC_MODELS TO ROLE ANALYTICS_TEAM;
GRANT USAGE ON WAREHOUSE SFE_SAM_SNOWMAN_WH TO ROLE ANALYTICS_TEAM;
GRANT USAGE ON SCHEMA SNOWFLAKE_EXAMPLE.SAM_THE_SNOWMAN TO ROLE ANALYTICS_TEAM;
GRANT USAGE ON AGENT SNOWFLAKE_EXAMPLE.SAM_THE_SNOWMAN.SAM_THE_SNOWMAN TO ROLE ANALYTICS_TEAM;
...
```sql
USE ROLE ACCOUNTADMIN;
REVOKE USAGE ON AGENT SNOWFLAKE_EXAMPLE.SAM_THE_SNOWMAN.SAM_THE_SNOWMAN FROM ROLE ANALYTICS_TEAM;
