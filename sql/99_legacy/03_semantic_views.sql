...
COMMENT = 'DEMO: Sam-the-Snowman - Query performance analytics. Analyze execution times, identify slow queries, detect memory spilling, evaluate cache efficiency, and track errors. Excludes system-managed warehouses. (Expires: 2026-04-18)';
...
COMMENT = 'DEMO: Sam-the-Snowman - Warehouse cost analysis. Track spending by warehouse, identify cost trends, support FinOps. Excludes system-managed warehouses. (Expires: 2026-04-18)';
...
COMMENT = 'DEMO: Sam-the-Snowman - Warehouse utilization and capacity planning. Monitor concurrency, queue depth, and sizing opportunities. Excludes system-managed warehouses. (Expires: 2026-04-18)';
