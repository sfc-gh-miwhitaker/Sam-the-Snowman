...
CREATE OR REPLACE NOTIFICATION INTEGRATION SFE_EMAIL_INTEGRATION
    ...
    COMMENT = 'DEMO: Sam-the-Snowman - Email notification integration for delivering agent output (Expires: 2026-04-18).';
...
HANDLER = 'send_email'
COMMENT = 'DEMO: Sam-the-Snowman - Sends HTML email using SYSTEM$SEND_EMAIL with proper SQL injection protection (Expires: 2026-04-18)'
AS
$$
